    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChatTrackers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChatTrackers_ChatRooms_ChatId",
                        column: x => x.ChatId,
                        principalTable: "ChatRooms",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ChatTrackers_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChatTrackers_ChatId",
                table: "ChatTrackers",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_ChatTrackers_UserId",
                table: "ChatTrackers",
                column: "UserId");
